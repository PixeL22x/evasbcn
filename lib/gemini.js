...
Formato requerido:
{
  ...
  "categoria": "helados|ingredientes|packaging|servicios|mantenimiento|otros",
  "lineas": [
    {
...
- "ingredientes": Leche, nata, azúcar, frutas, saborizantes
- "packaging": Conos, tarrinas, cucharillas, servilletas, vasos
- "servicios": Luz, agua, gas, internet, teléfono, limpieza
...
✓ El total debe coincidir con la suma de líneas + IVA`;
    ...
    throw new Error("Falló el análisis de la factura por IA");
  }
}
